...
class LinkedListTest<E>
{
    ...
    LinkedList<E> oneItemList = new LinkedList<>();
    LinkedList<E> fullList = new LinkedList<>();
    ...
    void testSet()
    {
        assertThrows(IllegalStateException.class, () -> emptyList.removeBack());
    ...
    {
        assertThrows(IllegalStateException.class, () -> emptyList.removeFront());
    ...
    {
        //remove(int i)
        assertThrows(IllegalStateException.class, () -> emptyList.remove((E) "0"));
